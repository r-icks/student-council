...
import TooManyRequests from "../Errors/too-many-req.js";
...
UserSchema.methods.generateOTP = function () {
  ...
  if (
    ...
    console.log(this.otp.genTime + resendTime);
    console.log(currentTime);
    console.log(this.otp.genTime + resendTime > currentTime);
...
UserSchema.methods.checkOTP = async function (code) {
  if (!this.otp.code) {
...
UserSchema.methods.createJWT = function (rememberUser) {
  return jwt.sign(
